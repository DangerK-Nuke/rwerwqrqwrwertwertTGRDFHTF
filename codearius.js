...
client.on("guildMemberAdd", (member, message) => {
  const sunucuid = "771784232183267328"; //Sunucu id
  const id = "772921798546423820"; //Kanal id
  const jail = "772921245942546443"; //jail rol id
  const kayıtsız = "772921245942546443"; //Kayıtsız rol id
  let resim = "https://i.pinimg.com/originals/69/8f/c4/698fc403722ae51a340fae16aaff46cf.gif"
...
Kayıt olmak için <@&778647434070458418> rolündeki yetkilileri etiketlemeyi unutma.`)
...
moment.locale("tr");
let kanal = client.channels.cache.get("772921798546423820")
await kanal.send(`**${member} Sunucu Katıldı. İsim ve yaş belirt**`).catch(e => console.log(e))
}); 
/////////////////////////////////////////////////
client.on('ready', ()=>{
client.channels.cache.get('785553662298423306').join()
})
//////////////////////////////////
